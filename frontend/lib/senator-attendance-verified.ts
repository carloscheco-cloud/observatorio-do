...
export const verifiedSenatorAttendance: Record<string, VerifiedSenatorAttendance[]> = {
  ...
  "secundino-velazquez-pimentel": [
    ...
    row("16 ago. 2025 – 12 ene. 2026", 24, 20, 4, 83.3, 16.7, dl2026b, "Cuatro faltas en 24 sesiones durante la legislatura analizada; 20 presencias calculadas por diferencia. La fuente no registra ausencias sin excusa para este corte."),
  ],
